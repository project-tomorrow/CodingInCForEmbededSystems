...
%\definecolor{darkred}{rgb}{0.5,0.5,0}
...
\lstset{ %
  ...
  emph={if,else,do,while,for,break,continue,sizeof,return,static,extern},    % add a empahsis on other keywords
  emphstyle=\bfseries\color{red},        % color on emphasised words
  emph={[2]typedef,struct,enum,unsigned,const,volatile
  ,void,char,int,long,float,uint8_t,uint16_t,uint32_t,int8_t,int16_t,int32_t},    % add a empahsis on other keywords
  emphstyle={[2]\bfseries\color{blue}},       % color on emphasised words
  emph={[3]@file,@brief,@param,@return,@warning,@note,
  @author,@verbatim,@endverbatim},    % add a empahsis on more keywords
  emphstyle={[3]\slshape\color{purple}},       % color on emphasised words
...
\fancyhead[R]{\includegraphics[scale=0.15]{pictures/ProToLogo.png}}
...
\begin{titlepage}
  ...
  \vspace*{\stretch{1}}
  \begin{center}
    Vincent \textsc{Ricchi} - Association \textsc{\textbf{ProTo}}\linebreak
    2017 / 2018
  \end{center}
\end{titlepage}
