...
\item Une citation de code apparait dans un encadré séparé, en police \xout{Consolas}\footnote{La police des extraits de code de ce document est encore indéterminée} avec les options de mise en forme définies ci-dessous :
\end{itemize}
